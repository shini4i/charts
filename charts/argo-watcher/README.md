...
![Version: 0.8.1](https://img.shields.io/badge/Version-0.8.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.9.1](https://img.shields.io/badge/AppVersion-v0.9.1-informational?style=flat-square)
...
| persistence.enabled | bool | `false` | Enable persistence using a Persistent Volume Claim |
| persistence.existingClaim | string | `""` | The name of an existing persistent volume claim to use |
...
| persistence.storageClassName | string | `""` | The storage class to use for the persistent volume claim. If undefined or null, the default storage class will be used. |
